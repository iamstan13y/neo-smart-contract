...
namespace TokenAliceTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class TokenAliceContractTests : IClassFixture<CheckpointFixture<TokenAliceContractTests>>
    {
        ...
        public TokenAliceContractTests(CheckpointFixture<TokenAliceContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<TokenAliceContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<TokenAliceContract>(c => c.changeNumber(42));
